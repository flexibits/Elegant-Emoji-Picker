...
public struct Emoji: Decodable, Equatable {
    ...
    public func duplicate(_ withSkinTone: EmojiSkinTone?) -> Emoji {
        Emoji(emoji: self.emoji(withSkinTone) ?? emoji, description: description, category: category, aliases: aliases, tags: tags, supportsSkinTones: supportsSkinTones, iOSVersion: iOSVersion)
    }
}
...
public enum EmojiCategory: String, CaseIterable, Decodable {
    ...
    public var image: UIImage? {
        ...
        default:
            return UIImage(named: self.rawValue, in: .module, with: nil)?.withRenderingMode(.alwaysTemplate)
        }
    }
...
public struct ElegantConfiguration {
    ...
    public var defaultSkinTone: EmojiSkinTone?
