...
public protocol ElegantEmojiPickerDelegate: AnyObject {
    ...
    /// - Parameters:
    ///   - picker: Emoji picker view informing the delegate.
    ///   - toIndex: New focused section index.
    ///   - fromIndex: Previously focused section index.
    func emojiPicker(_ picker: ElegantEmojiPicker, focusedSectionChanged toIndex: Int, fromIndex: Int)
...
extension ElegantEmojiPickerDelegate {
    ...
    public func emojiPicker(_ picker: ElegantEmojiPicker, focusedSectionChanged toIndex: Int, fromIndex: Int) {}

    public func emojiPicker(_ picker: ElegantEmojiPicker, searchResultFor prompt: String, fromAvailable: [EmojiSection]) -> [Emoji] {
        ElegantEmojiPicker.getSearchResults(prompt, fromAvailable: fromAvailable)
    }
    ...
    public func emojiPickerShouldDismissAfterSelection(_ picker: ElegantEmojiPicker) -> Bool { true }
    ...
    public func emojiPicker(_ picker: ElegantEmojiPicker, loadEmojiSections withConfiguration: ElegantConfiguration, _ withLocalization: ElegantLocalization) -> [EmojiSection] {
        ElegantEmojiPicker.getDefaultEmojiSections(config: withConfiguration, localization: withLocalization)
    }
